...
- 法人カード
    - 現在、OLTAやINVOYという既存の2つのプロダクトを展開する中で見えてきた「法人カードがつくれない」「与信額が十分ではない」という悩みを抱えた中小企業や個人事業主の力になるため、OLTA独自のナレッジや技術を活用した、全く新しい与信を採用した法人カードの開発に挑戦しています。
    - これまでOLTAのプロダクトではサーバーサイド開発にPythonを採用していましたが、堅牢性と処理速度の観点から当プロダクトにおいてはGo言語を選定しました。
    - バックエンドサービス間の通信にはgRPCを、フロントエンドサービスとの通信にはGraphQLを利用しています。
    - インフラにはGCP/GKEを活用しています。

#### 採用情報

OLTAはGo言語エンジニアを絶賛募集中です。まずはカジュアルにお話ししましょう！

- [エンジニア向け採用情報](https://corp.olta.co.jp/recruit_engineers)
- [OLTA TECH BLOG](https://techblog.olta.co.jp/)
